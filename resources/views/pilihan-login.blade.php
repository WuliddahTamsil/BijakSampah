...
<body>
    <div class="container">
        ...
        <div class="right-section">
            ...
            <h1 class="welcome-text">
                ...
                <img src="asset/img/Logo Alternative_Dark.png" alt="BijakSampah Logo" class="bijaksampah-logo">
            </h1>
            ...
            <div class="form-container" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="password" id="registerPassword" placeholder="Buat password Anda">
    ...
    <div class="modal" id="forgotPasswordModal">
        <div class="modal-content">
            <h3>Lupa Password</h3>
            <p id="passwordInfoText">Password Anda dapat dilihat di profil Anda setelah login.</p>
